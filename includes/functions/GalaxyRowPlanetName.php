...
function GalaxyRowPlanetName ( $GalaxyRow, $GalaxyRowPlanet, $GalaxyRowUser, $Galaxy, $System, $Planet, $PlanetType ) {
	...
	if (isset($GalaxyRowUser['ally_id']) && $GalaxyRowUser['ally_id'] == $user['ally_id'] AND
	...
	if (isset($GalaxyRowPlanet['last_update']) && $GalaxyRowPlanet['last_update'] > (time()-59 * 60) AND
	...
	} elseif (isset($GalaxyRowPlanet["destruyed"]) && $GalaxyRowPlanet["destruyed"] != 0) {
