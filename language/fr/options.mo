...
$lang['succeful_changepass'] = "Le mot de passe a bien été changé.<br /><a href=\"login.php\" target=\"_top\">Retour</a>";
$lang['succeful_save'] = "Les changements ont été sauvegardé.<br /><a href=\"options.php\">Retour</a>";
...
$lang['emaildir_tip'] = "Cette adresse peut être changée à tout moment. L'adresse deviendra permanente s'il n'y a pas de changemements pendant les 7 jours qui suivent.";
...
// Admin Options
$lang['opt_adm_title'] = "Options réservées a l'administration";
$lang['opt_adm_planet_prot'] = "Protection des planètes";
...
// Option galaxy
$lang['galaxyvision_options'] = "Paramétrage de la vue de la galaxie";
$lang['spy_cant'] = "Nombre de sondes";
$lang['spy_cant_tip'] = "Nombre de sondes d'espionnage envoyées depuis le menu galaxie à chaque fois que vous espionnez quelqu'un.";
...
$lang['vacations_tip'] = "Le mode vacances est là pour vous protéger pendant votre absence.";
$lang['deleteaccount'] = "Effacer le compte";
$lang['deleteaccount_tip'] = "Ton compte sera complètement effacé dans 7 jours.";
