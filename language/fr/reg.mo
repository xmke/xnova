...
$lang['accept']            = 'J\'accèpte le règlement';
$lang['signup']            = ' S\'enregistrer ';
$lang['neededpass']        = 'Mot de passe';
$lang['code_secu']          = 'Securite';

// Send
$lang['mail_welcome']      = 'Merci beaucoup de votre inscription à notre jeu ({gameurl}) \nVotre mot de passe est : {password}\n\nBon amusement !\n{gameurl}';
$lang['mail_title']        = 'Enregistrment';
$lang['thanksforregistry'] = 'Merci de vous être inscrit ! Vous allez recevoir un mail avec votre mot de passe.';
